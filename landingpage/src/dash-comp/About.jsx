  ...
  return (
    <section id="about">
      <div className="relative w-full flex flex-col w md:mt-[2%] overflow-hidden">
        ...
        <div className=" relative flex flex-col md:ml-[18%] md:mt-[3%] text-[7vw] md:text-[4.16vw] w-full">
          <h1 className="font-[Poller One] font-[900]  mx-auto whitespace-nowrap">
            {name}
          </h1>
          <span className="font-[sacramento] text-[7vw] md:text-[5vw] mt-[-5%] md:mt-[-2%] ml-[53%] text-[#ED6C30] capitalize">
            {profession}
          </span>
        </div>

        {/* Image and About */}
        <div className="relative flex flex-col md:flex-row md:w-[80vw] mx-auto">
          {/* Image and visitiors count */}
          <div className=" relative flex flex-col w-full md:mt-[-15%]">
            <div className="relative flex">
              <img
                className=" z-20 w-[57vw] md:w-[27vw] rounded-full md:mt-[-3%] mx-auto border border-[#ED6C30] border-[3vw] md:border-[1vw]"
                src={`https://admin.artpallatte.com/${profile}`}
                alt=""
              />
              <img
                className="absolute z-10 inset-0 mt-[50%] md:mt-[55%] w-[40vw] md:w-[17vw] mx-auto"
                src="/logos/art.png"
                alt=""
              />
            </div>
            <div>
              <img
                ...
                alt=""
              />
              <div className="relative flex mt-[12%] text-[#006CA2] font-[600] text-[7.27vw] md:text-[2.78vw] mx-auto justify-center">
          ...
          {/* About Us */}
          <div className="relative flex flex-col w-full mt-[5%] md:mt-[-2%]">
            ...
            <div className="hidden md:flex w-[36vw] flex-col drop-shadow-md shadow-xl rounded-xl px-[2%] py-[1%] mt-[3%]">
